  ...
  return (
    <section id="cardType" className="section">
      ...
      <div className="card_inner container">
        ...
        <article className="card">
          <figure className="card_header">
            <img src="assets/img/dessert02.jpg" alt="" />
          </figure>
          <div className="card_body">
            <h3 className="tit">다양한 케이크&디저트</h3>
            <p className="desc">
              커피 전문점조차 낯설었던 2002년, 1호점인 신촌점을 시작으로 투썸플레이스는 프리미엄 디저트 카페 브랜드로서
              커피는 물론 다양한 디저트를 함께 즐기는 새로운 새로운새로운새로운
            </p>
            <a href="#" className="btn">
              더 자세히 보기
              <span>
        ...
        <article className="card">
          <figure className="card_header">
            <img src="assets/img/dessert03.jpg" alt="" />
          </figure>
          <div className="card_body">
            <h3 className="tit">'트렌디 카페 밀' 컨셉의 델리</h3>
            <p className="desc">
              커피 전문점조차 낯설었던 2002년, 1호점인 신촌점을 시작으로 투썸플레이스는 프리미엄 디저트 카페 브랜드로서
              커피는 물론 다양한 디저트를 함께 즐기는 새로운새로운새로운새로운
            </p>
            <a href="#" className="btn">
              더 자세히 보기
              <span>
