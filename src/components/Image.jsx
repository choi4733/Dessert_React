      ...
      <div className="image_inner container">
        <article className="image img1">
          ...
          <p className="image_desc">
            강렬한 레드시트에 고소한 생크림과 상큼한 딸기 콤포트를 샌드하고 신선한 생딸기를 가득 올린 케이크 신선한
            생딸기를 가득 올린 케이크
          </p>
          <p className="image_btn">자세히 보기</p>
        </article>
        <article className="image img2">
          <h3 className="image_title">스토로베리 초콜릿 생크림</h3>
          <p className="image_desc">
            한가득 올린 상큼한 딸기, 크런치 초코볼이 초콜릿 생크림 사이사이 씹히는 투썸 시그니처 투썸 시그니처 케이크
          </p>
